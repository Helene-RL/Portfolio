...
public class PiocheRessource implements Section {

	// emplacement dans la pioche
	//=============================
	private RessourceCard pioche;
	private RessourceCard card1;
	private RessourceCard card2;
	//=============================

	// Constructeur
	//=======================================
	public PiocheRessource() {
	...
	// Generer des cartes Ressources avec des valeurs aleatoire
	//=======================================================
	public RessourceCard placecard(boolean face) {
		Random random = new Random();
		int point = random.nextInt(2);
		int type = random.nextInt(4);
		return new RessourceCard(tableau[type], point, face);
	}
	//=======================================================
	...
	public void draw(Graphics2D graph, Coordinate coin, int width, int height, GameData data) {
		...
		graph.drawString("Carte ressource :", coin.x()+15, 40);
	...
	// Méthode pour dessiner les cartes ressources dans la pioche ressource
	//================================================================================================
	...
	public void drawclicker(Graphics2D graph, int x, int y,Card carddata) {
		...
		drawcardclicker(graph, x, y + 130, card1,carddata);
		drawcardclicker(graph, x, y + 250, card2,carddata);
	}
	//================================================================================================

	// Méthode pour dessiner un contour lorsque la carte est selectionner
	//================================================================================================
	public void drawcardclicker(Graphics2D graph, int x, int y, RessourceCard carte,Card carddata) {
	...
	// Méthode pour remplacer une carte lorsque la carte est piochée
	//================================================================================================
	...
	//================================================================================================
	public RessourceCard action(int i, int j, int x, int y, MainJ mainjoueur,GameData data) {
	...
	//==================================================================================================
	private boolean verifie(int i, int j, int x, int y, RessourceCard card, int nb, MainJ mainjoueur,GameData data) {
